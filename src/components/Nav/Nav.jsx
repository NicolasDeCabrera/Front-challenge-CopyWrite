        ...
        <nav className="navbar navbar-light bg-dark">
            <div className="container-fluid d-flex justify-content-center">
                <form className="d-flex col-6 col-md-4 justify-content-center">
                    <input value={word} onChange={(e) => setWord(e.target.value)} className="form-control me-2 col-10" type="search" placeholder="Insert text" aria-label="Search" />
                    <button onClick={search} className="btn btn-outline-success" type="submit">Send</button>
                </form>
            </div>
        </nav>
    )
